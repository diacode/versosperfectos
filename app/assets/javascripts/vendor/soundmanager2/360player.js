...
function ThreeSixtyPlayer() {
  ...
  this.config = {
    ...
    loadRingColor: '#808080', // how much has loaded
    playRingColor: '#fd8411', // how much has played
    backgroundRingColor: 'transparent', // color shown underneath load + play ("not yet loaded" color)
