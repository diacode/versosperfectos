...
describe "admin/artists/new" do
  before(:each) do
    assign(:admin_artist, stub_model(Admin::Artist,
      :name => "MyString",
      :real_name => "MyString",
      :bio => "MyText",
      :management_id => 1,
  ...
  it "renders new admin_artist form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => admin_artists_path, :method => "post" do
